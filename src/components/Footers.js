...
const Footers = () => {
  ...
  useEffect(() => {
    console.log("Footers is rendering"); // Debugging
    document.body.style.overflow = "auto"; // ✅ Allow scrolling
    
    
    return () => {
      document.body.style.overflow = "hidden"; // ✅ Lock scrolling when leaving
      document.body.removeAttribute('data-footers-active');
    };
  }, []);
    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        ...
        <div className={styles.logoSection}>
          ...
          <h2 className={styles.thanks}>Thanks for </h2><br /><br />
          <h2 className={styles.thanks}>Chooooooosing us</h2>
        </div>
